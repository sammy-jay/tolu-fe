  ...
  return (
    <div>
      {paymentLink.link && (
        <div
          onClick={clear}
          className="fixed h-full w-full top-0 left-0 bg-black bg-opacity-60 z-10 flex justify-center items-center"
        >
      ...
      {paymentLink.state && (
        <div
          ...
          className="fixed h-full w-full top-0 left-0 bg-black bg-opacity-60 z-10 flex justify-center items-center"
        >
          <div className="w-40 h-40 border-y-2 rounded-full border-slate-200 animate-spin flex items-center justify-center text-xl"></div>
        </div>
      )}
